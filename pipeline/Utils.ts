...
const diacriticToBase: { [key: string]: string } = {};
...
export const stripDiacritics = (str: string) => str.replace(anyDiacritic, (match) => diacriticToBase[match]);

export const searchFormat = (str: string): string => {
    str = str.replace(/^\s+|\s+$/g, ""); // trim
    str = str.toLocaleLowerCase(); // ignore casing
